...
use nl_hecate_core::model::{MAGConfig, MAGParams, MemoryRuleKind, CompositionKind, HopeVariant, LatticeVariant, MomentumKind, ProjectionKind, FeatureMapKind};
...
fn make_test_config(rule: MemoryRuleKind) -> MAGConfig {
    MAGConfig {
        ...
        k: 1,
        chunk_sizes: vec![1],
        d_hidden: 0, lp_p: 2.0, sign_sharpness: 10.0, lq_q: 2.0, lambda_local: 0.0, lambda_2: 0.0,
        ...
        tape_multiplier: 1,
            ...
            memory_activation: Default::default(),
