...
The HOPE reference implementation (`HOPE/src/hope/m3_optimizer.py` line 206) uses
**addition**: `M2.mul_(beta3).add_(grad, alpha=1.0 - beta3)`. Both M¹ and M² are
additive EMA. Our implementation matches the reference code, not the LaTeX.
